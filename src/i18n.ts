const messages = {
  en: {
    ...
    addMask: 'Add mask',
    revealMasks: 'Reveal hidden areas (hold to peek)',
    hideMasks: 'Hide again',
    clearMasks: 'Clear all masks',
    underlayShow: 'Show reference underlay',
    underlayHide: 'Hide reference underlay',
    gridMenu: 'Grid',
    gridModeNone: 'No grid',
    gridModeNormal: 'Normal grid',
    gridModeLarge: 'Large grid',
    gridModePerspective: 'Perspective grid',
    perspectiveRotation: 'Rotation',
    perspectiveStrength: 'Perspective strength',
    perspectivePlaceCenter: 'Place grid anchor',
    perspectiveReset: 'Reset perspective grid',
    perspectiveMemoryRecall: 'Recall sketched angle',
    perspectiveMemoryDelete: 'Delete selected angle memory',
    expandPerspectiveController: 'Perspective grid controls',
    collapsePerspectiveController: 'Collapse controls',
    ...
    previewDrawingTitle: 'Drawing preview',
    continueDrawing: 'Continue this drawing',
    continueConfirmMessage: 'The canvas has unsaved changes. Replace them with this drawing?',
    continueConfirmLoad: 'Replace',
    closePreview: 'Close',
    buildDate: 'Build',
    url: 'URL',
  ...
  ja: {
    ...
    addMask: 'マスクを追加',
    revealMasks: '隠した部分を表示（長押しで一時表示）',
    hideMasks: '再び隠す',
    clearMasks: 'マスクをすべて消去',
    underlayShow: '手本を下敷きに表示',
    underlayHide: '下敷きを非表示',
    gridMenu: 'グリッド',
    gridModeNone: 'グリッドなし',
    gridModeNormal: '通常グリッド',
    gridModeLarge: '大グリッド',
    gridModePerspective: 'パースグリッド',
    perspectiveRotation: '回転',
    perspectiveStrength: 'パース強度',
    perspectivePlaceCenter: '基準点を配置',
    perspectiveReset: 'パースグリッドをリセット',
    perspectiveMemoryRecall: '描いたアングルに戻す',
    perspectiveMemoryDelete: '選択中のメモリーを削除',
    expandPerspectiveController: 'パースグリッド操作',
    collapsePerspectiveController: '操作パネルをたたむ',
    fullscreen: '全画面',
    ...
    previewDrawingTitle: '作品プレビュー',
    continueDrawing: 'この続きを描く',
    continueConfirmMessage: 'キャンバスに未保存の描きかけがあります。この作品で置き換えますか？',
    continueConfirmLoad: '置き換える',
    closePreview: '閉じる',
    buildDate: 'ビルド',
    url: 'URL',
    urlPlaceholder: 'https://...',
